...
```bash
$ mvn archetype:generate -DartifactId=lambda_jersey_test_1 -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-jersey-archetype -DarchetypeVersion=1.5.1 -DgroupId=com.lindronics -Dversion=1.0-SNAPSHOT -Dinteractive=false
$ cd lambda_jersey_test_1
$ sam build
Building resource 'Lambda_jersey_test_1Function'
...
-------------------------------------------------------------------------------------------------------------
Lambda_jersey_test_1Api - URL for application            https://xxxxxxxxxx.execute-api.us-west-2.amazonaws.com/Prod/pets
-------------------------------------------------------------------------------------------------------------
```
